...
# see https://github.com/docker/docker-ce/releases/tag/v18.09.3

# download install the docker binaries.
$archiveVersion = '18.09.3'
...
$archiveHash = '06d68cdb699287e4a54debef0c0cde10174b8f3b7f5095e092497f82f3f3f651'
